...
const defaultMessages: Message[] = [
  ...
  {
    messageType: MessageType.User,
    text: "Create a playlist with the latest from my favorite songs and podcasts.",
    date: new Date(),
  },
];
...
export default function Home() {
  ...
  return (
    <div className="font-sans grid grid-rows-[auto_1fr_auto] items-center justify-items-center min-h-screen p-4 sm:p-8 md:p-12 ">
      <main className="flex flex-col gap-8 row-start-2 items-center w-full max-w-screen-xl sm:max-w-2xl sm:px-4 mb-56 md:mb-48">
